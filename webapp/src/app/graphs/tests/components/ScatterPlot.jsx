            ...
            <div
                ...
                <div className="flex flex-wrap justify-between items-end mb-4 gap-4">
                    ...
                    <div className="flex flex-wrap gap-4">
                        <div>
                            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">X
                                Axis</label>
                            <select
                                value={xField}
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Y
                                Axis</label>
                            <select
                                value={yField}
                    ...
                    {/* Season buttons */}
                    <div>
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Olympic
                            Season</label>
