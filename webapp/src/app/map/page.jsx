    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-slate-900 olympic-bg">
            ...
            <div className="relative z-10">
                <div
                    className="bg-white/95 dark:bg-gray-800/80 backdrop-blur-sm mx-4 my-4 rounded-2xl p-6 border border-gray-200/50 dark:border-gray-600/50 shadow-lg">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-gray-700 dark:text-gray-400 mt-2 text-sm md:text-base">
                                    Explore Olympic venues across different map layers and discover their historical
                                    significance
                                </p>
                            </div>
                        </div>
            ...
            <div className="mx-4 mb-4">
                <div className="h-[600px] relative">
                    {viewMode === 'map' ? (
                        ...
                        <div
                            className="h-full bg-white/95 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl border border-gray-200/50 dark:border-gray-600/50 shadow-lg overflow-hidden relative">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        <div>
                            ...
                            <p className="text-gray-700 dark:text-gray-400 text-sm md:text-base">
                                Use map layer controls to switch views • Click on venue markers for detailed information
                                • Zoom and pan to explore different regions
                            </p>
                        </div>
                        <div className="flex flex-wrap gap-2">
                            <span
                                className="px-3 py-1 bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300 rounded-full text-xs font-medium border border-blue-200 dark:border-blue-700">
                                Interactive
                            </span>
                            <span
                                className="px-3 py-1 bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300 rounded-full text-xs font-medium border border-green-200 dark:border-green-700">
                                Multi-layer
                            </span>
                            <span
                                className="px-3 py-1 bg-purple-100 dark:bg-purple-900/30 text-purple-800 dark:text-purple-300 rounded-full text-xs font-medium border border-purple-200 dark:border-purple-700">
                                Historical Data
                            </span>
                        </div>
                    </div>
