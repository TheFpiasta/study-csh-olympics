    ...
    return (
        <div className="space-y-8">
            ...
            <div
                ...
                <div
                    className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 mb-4 flex flex-wrap gap-2 justify-between items-center">
                    <div>
                ...
                <div className="h-96 chart-container">
                    ...
                    <ResponsiveLine
                        ...
                        tooltip={({point}) => (
                            <div
                                className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-xl border border-gray-200 dark:border-gray-600">
