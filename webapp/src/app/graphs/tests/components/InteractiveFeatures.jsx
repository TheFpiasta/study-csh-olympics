            ...
            <div
                ...
                <div className="bg-white dark:bg-gray-900 rounded-lg p-4 h-96 relative">
                    {scatterData.length > 0 ? (
                        <ResponsiveScatterPlot
                            ...
                            tooltip={({node}) => (
                                <div
                                    className="bg-white dark:bg-gray-800 p-4 border border-gray-200 dark:border-gray-600 rounded-lg shadow-xl max-w-xs w-80">
                                    <div className="space-y-2">
                                        <div
                                            className="font-bold text-lg text-gray-900 dark:text-gray-100 border-b border-gray-200 dark:border-gray-600 pb-2">
                                            {node.data.venue}
                                        </div>
                                        <div className="grid grid-cols-2 gap-3 text-sm">
                                            <div>
                                                <span
                                                    className="font-medium text-gray-700 dark:text-gray-300">Location:</span>
                                                <div
                                                    className="text-gray-600 dark:text-gray-400">{node.data.location}</div>
                                            </div>
                                            <div>
                                                <span
                                                    className="font-medium text-gray-700 dark:text-gray-300">Year:</span>
                                                <div className="text-gray-600 dark:text-gray-400">{node.data.x}</div>
                                            </div>
                                            <div>
                                                <span
                                                    className="font-medium text-gray-700 dark:text-gray-300">Capacity:</span>
                                                <div
                                                    className="text-gray-600 dark:text-gray-400 font-mono">{node.data.y.toLocaleString()}</div>
                                            </div>
                                            <div>
                                                <span
                                                    className="font-medium text-gray-700 dark:text-gray-300">Season:</span>
                                        ...
                                        <div className="pt-2 border-t border-gray-200 dark:border-gray-600">
                                            ...
                                            <div
                                                className="text-gray-600 dark:text-gray-400 mt-1 text-sm leading-relaxed">
                                                {node.data.sports}
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div className="flex items-center justify-center h-full">
                            <p className="text-gray-500 dark:text-gray-400">No data available for the selected
                                filters</p>
                        </div>
                    )}
                </div>
                ...
                <div className="mt-8">
                    ...
                    <div className="bg-white dark:bg-gray-900 rounded-lg p-4 h-96">
                        {networkData.nodes.length > 0 ? (
                            <ResponsiveNetwork
                                ...
                                tooltip={({node}) => (
                                    <div
                                        className="bg-white dark:bg-gray-800 p-3 border border-gray-200 dark:border-gray-600 rounded-lg shadow-lg max-w-xs">
                                        <div
                                            className="font-semibold text-gray-900 dark:text-gray-100">{node.label}</div>
                                        <div className="text-sm text-gray-600 dark:text-gray-400 capitalize">
                                            {node.type === 'center' &&
                                                <span className="text-yellow-600 font-medium">🏅 Olympic Hub</span>}
                                            {node.type === 'city' &&
                                                <span className="text-orange-600 font-medium">🏙️ Host City</span>}
                                            {node.type === 'venue' &&
                                                <span className="text-green-600 font-medium">🏟️ Olympic Venue</span>}
                                            {node.type === 'sport' &&
                                                <span className="text-blue-600 font-medium">⚽ Olympic Sport</span>}
                                        </div>
                            ...
                            <div className="flex flex-col items-center justify-center h-full">
                                ...
                                <p className="text-sm text-gray-400 dark:text-gray-500">Try adjusting your filters to
                                    see connections</p>
                            </div>
                        )}
                    </div>
                    ...
                    <div className="mt-2 text-center">
                        <p className="text-xs text-gray-500 dark:text-gray-400">
                            💡 Hover over nodes for details • Click nodes to focus • Network auto-adjusts for better
                            visualization
                        </p>
                    </div>
                    ...
                    <div className="mt-4 grid grid-cols-1 md:grid-cols-4 gap-4">
                        <div className="bg-yellow-50 dark:bg-yellow-900/20 rounded-lg p-3">
                            <div className="flex items-center gap-2 mb-1">
                                ...
                                <span
                                    className="text-sm font-medium text-yellow-800 dark:text-yellow-200">Olympics</span>
                            </div>
                ...
                <div className="mt-8">
                    <div className="mb-4">
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                            Flow showing: Construction Era → Venue Type (Indoor/Outdoor) → Sports Categories → Season
                            Type
                        </p>
                    </div>
                            ...
                            <ResponsiveSankey
                                ...
                                tooltip={({node}) => (
                                    <div
                                        ...
                                        <div className="text-sm text-gray-600 dark:text-gray-400 capitalize">
                                            {node.category === 'era' &&
                                                <span className="text-amber-600 font-medium">�️ Construction Era</span>}
                                            {node.category === 'venue_type' &&
                                                <span className="text-green-600 font-medium">�️ Venue Type</span>}
                                            {node.category === 'sport_category' &&
                                                <span className="text-blue-600 font-medium">� Sports Category</span>}
                                            {node.category === 'season' &&
                                                <span className="text-purple-600 font-medium">❄️☀️ Season Type</span>}
                                        </div>
                                        <div className="text-xs text-gray-500 dark:text-gray-500 mt-1">
                    ...
                    <div className="mt-2 text-center">
                        <p className="text-xs text-gray-500 dark:text-gray-400">
                            💡 Hover over nodes and links for details • Flow thickness represents venue capacity • Colors
                    ...
                    <div className="mt-4 grid grid-cols-1 md:grid-cols-4 gap-4">
                        <div className="bg-amber-50 dark:bg-amber-900/20 rounded-lg p-3">
                            <div className="flex items-center gap-2 mb-1">
                                ...
                                <span className="text-sm font-medium text-amber-800 dark:text-amber-200">Construction
                                    Era</span>
                            </div>
                        ...
                        <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-3">
                            <div className="flex items-center gap-2 mb-1">
                                ...
                                <span
                                    className="text-sm font-medium text-green-800 dark:text-green-200">Venue Type</span>
                            </div>
                            <div className="text-xs text-green-600 dark:text-green-400">Indoor vs outdoor facilities
                            </div>
                        </div>
                        <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-3">
                            <div className="flex items-center gap-2 mb-1">
                                <div className="w-4 h-4 rounded-full bg-blue-400"></div>
                                <span
                                    className="text-sm font-medium text-blue-800 dark:text-blue-200">Sports
                                    Categories</span>
                            </div>
                        ...
                        <div className="bg-purple-50 dark:bg-purple-900/20 rounded-lg p-3">
                            <div className="flex items-center gap-2 mb-1">
                                ...
                                <span
                                    className="text-sm font-medium text-purple-800 dark:text-purple-200">Season
                                    Type</span>
                            </div>
                            <div className="text-xs text-purple-600 dark:text-purple-400">Winter vs Summer Olympics
                            </div>
                        </div>
                    </div>
                </div>
