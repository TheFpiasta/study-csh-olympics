...
input_dir = os.path.join(os.path.dirname(__file__), "01_scraped_websites")
output_dir = os.path.join(os.path.dirname(__file__), "02_basic_geojsons")
...
for key, geojson in geojson_groups.items():
    ...
    # Also copy to final directory
    final_path = os.path.join(final_dir, f"{key}.geojson")
