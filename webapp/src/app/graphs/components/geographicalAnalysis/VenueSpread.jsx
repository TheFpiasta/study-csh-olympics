            ...
            <div
              ...
              <div className="space-y-2">
                <div className="flex justify-between">
                  <span className="font-medium text-gray-700 dark:text-gray-300">Venue Count:</span>
                  <span className="text-gray-900 dark:text-gray-100">{node.data.x} venues</span>
                </div>
                <div className="flex justify-between">
                  <span className="font-medium text-gray-700 dark:text-gray-300">Geographic Spread:</span>
                  <span className="text-gray-900 dark:text-gray-100 font-bold">{node.data.y} km</span>
                </div>
                <div className="flex justify-between">
                  <span className="font-medium text-gray-700 dark:text-gray-300">Avg Spread per Venue:</span>
