                                    ...
                                    <div className="space-y-2">
                                        <div className="flex justify-between">
                                            <span
                                                ...
                                                Venues:</span>
                                            <span
                                                className="text-gray-900 dark:text-gray-100">{node.venues?.length || 0}</span>
                                        </div>
                                        ...
                                        <div className="flex justify-between">
                                            ...
                                            <span
                                                className="text-gray-900 dark:text-gray-100">{node.sports?.length || 0}</span>
                                        </div>
                                    ...
                                    <div
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            {venue.type && (
                                                <div className="flex justify-between">
                                                    <span
                                                        className="font-medium text-gray-700 dark:text-gray-300">Type:</span>
                                                    <span
                                                        className="text-gray-900 dark:text-gray-100">{venue.type}</span>
                                                </div>
                                            )}
                                            ...
                                            {venue.location && (
                                                <div className="flex justify-between">
                                                    ...
                                                    <span
                                                        className="text-gray-900 dark:text-gray-100 text-sm">{venue.location}</span>
                                                </div>
                                            )}
                                            {venue.opened && (
                                                <div className="flex justify-between">
                                                    <span
                                                        className="font-medium text-gray-700 dark:text-gray-300">Opened:</span>
                                                    <span
                                                        className="text-gray-900 dark:text-gray-100">{venue.opened}</span>
                                                </div>
                                            )}
                                        </div>
                                    </div>
