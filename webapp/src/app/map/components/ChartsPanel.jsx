    ...
    if (!geojsonData) {
        return (
            <div className="flex flex-col items-center justify-center h-full p-8 text-center">
                <div
                    className="flex items-center justify-center w-16 h-16 mb-4 bg-gray-100 rounded-full dark:bg-gray-700">
    ...
    return (
        <div className="flex flex-col h-full">
            ...
            <div className={`${showTimelineChart ? 'mb-4' : 'mb-6'}`}>
                ...
                <div
                    className={`${showTimelineChart ? 'h-52' : 'h-52'} bg-gray-50 dark:bg-gray-800/50 rounded-lg p-2 chart-container`}>
                    <style jsx>{`
