                    ...
                    >
                        <div className="p-3 max-w-sm">
                            ...
                            <div className="text-sm space-y-2">
                                <div>
                                    <span
                                        className="font-semibold text-gray-700">Location:</span> {selectedVenue.properties.place}
                                </div>
                                <div>
                                    <span
                                        className="font-semibold text-gray-700">Sports:</span> {selectedVenue.properties.sports?.join(', ')}
                                </div>
                                <div>
                                    <span
                                        className="font-semibold text-gray-700">Type:</span> {selectedVenue.properties.type}
                                </div>
                                {selectedVenue.properties.venue_use && (
                                    <div>
                                        <span
                                            className="font-semibold text-gray-700">Use:</span> {selectedVenue.properties.venue_use}
                                    </div>
                                )}
