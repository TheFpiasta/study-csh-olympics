...
const CapacityBoxPlot = ({data}) => {
    ...
    useEffect(() => {
        ...
        if (data?.games) {
            const years = data.games.map(game => Number(game.year)).filter(year => !isNaN(year));
            if (years.length > 0) {
                    ...
                    <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 mb-4">
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                            ...
                            <span className={"ml-3 text-xs text-gray-500 dark:text-gray-400"}>
                                (Only include games where at least this percentage of venues have seating capacity data.
                                0% =
                                all games, 100% = only games where all venues have seating data)
                            </span>
                        </label>
                        <div className="text-center text-sm font-medium text-gray-900 dark:text-gray-100 mb-3">
                            {maxPercentageFilled}%
                                ...
                                tooltip={({group, data, outliers}) => {
                                    ...
                                    return (
                                        <div
                                            ...
                                            {data?.values && (
                                                <div className="space-y-1">
                                                    <div className="flex justify-between text-sm">
                                                        <span
                                                            className="text-gray-600 dark:text-gray-400">Minimum:</span>
                                                    ...
                                                    <div className="flex justify-between text-sm">
                                                        <span
                                                            className="text-gray-600 dark:text-gray-400">First Quartile
                                                            (Q1):</span>
                                                        <span className="font-medium text-gray-900 dark:text-gray-100">
                                                    ...
                                                    <div className="flex justify-between text-sm">
                                                        <span className="text-gray-600 dark:text-gray-400">Median
                                                            (Q2):</span>
                                                        <span className="font-medium text-gray-900 dark:text-gray-100">
                                                    ...
                                                    <div className="flex justify-between text-sm">
                                                        <span
                                                            className="text-gray-600 dark:text-gray-400">Third Quartile
                                                            (Q3):</span>
                                                        <span className="font-medium text-gray-900 dark:text-gray-100">
                                                    ...
                                                    <div className="flex justify-between text-sm">
                                                        <span
                                                            className="text-gray-600 dark:text-gray-400">Maximum:</span>
                                                        <span className="font-medium text-gray-900 dark:text-gray-100">
                                            ...
                                            {outliers?.length > 0 && (
                                                <div
                                                    className="mt-3 pt-2 border-t border-gray-200 dark:border-gray-600">
